...
vjs.createEl = function(tagName, properties){
  ...
  for (propName in properties){
    if (hasOwnProp.call(properties, propName)) {
      ...
      // The additional check for "auth_rule" is because the default method for adding attributes does not
      // add the attribute "auth_rule". My guess is because it's not a valid attribute in some namespaces, although
